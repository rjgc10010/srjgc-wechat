...
class SRjgcWechat{
    ...
    public function message(){
        ...
        if ($this->postData['MsgType']=='event'){
            ...
            elseif ($this->postData['Event']=='CLICK'){
                if ($this->postData['EventKey']=='FWPT_ZSDZZN'){
                    $content='尊敬的用户,您可以根据您的自身定位，量身打造专属您的智能网咖。
1.人脸识别;2.动态识别;3.人工智能(降低;4.收银台物联微信;5.专属APP
;6.品牌LOGO定制;7.防盗物联;8.专属营销功能开发。9.语音控制整个网吧操控。
私人定制请联系我们商务。热线:152-7716-9026;小高
';
                    $message->response($content,$this->postData,Message::MSG_TYPE_TEXT);
                }
                elseif ($this->postData['EventKey']=='BZZX_LXKG'){
                    $content='尊敬的用户，遇见问题请先按排查问题处理。
请联系当地供应商技术支持。
或者咨询400-878-6069';
                    $message->response($content,$this->postData,Message::MSG_TYPE_TEXT);
                }
